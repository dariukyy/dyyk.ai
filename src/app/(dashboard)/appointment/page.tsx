...
const Page = async (props: Props) => {
  ...
  return (
    <>
      <InfoBar />
      <div className="grid grid-cols-1 lg:grid-cols-3 flex-1 h-0 gap-5 pb-10">
        ...
        <div className="col-span-1">
          <Section
            label={`${
              bookingsExistToday.length ? bookingsExistToday.length : ""
            } Booking${bookingsExistToday.length === 1 ? "" : "s"} For Today`}
